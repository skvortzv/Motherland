...
<title>Motherland - объявление</title>
<main class = "addads">
    <h1>Добавить объявление</h1>
    <form action = "" method = "POST" enctype="multipart/form-data">
        <label for = "ads-image">Изображение:<input type="file" name = "ads-image" id = "ads-image" accept="image/png, image/jpeg" required></label>
        <small id = "ads-image-message">Максимальный размер 2 Mb</small>
        <label for = "ads-header">Заголовок:<input name = "ads-header" id = "ads-header" autocomplete="off" required></label>
        <label for = "ads-description">Описание:<textarea name = "ads-description" id = "ads-description" autocomplete="off" required></textarea></label>
        <label for = "ads-region">Регион:<select name="ads-region" id = "ads-region">
        ...
        <label for = "ads-city">Город:<select name = "ads-city" id = "ads-city">
                <option value="Москва">Москва</option>
                <option value="Санкт-Петербург">Санкт-Петербург</option>
        ...
        <label for = "ads-coordinates">Метка:<input name = "ads-coordinates" id = "ads-coordinates" autocomplete="off" placeholder="[55.75399399999374,37.62209300000001]" required></label>
        <small>https://yandex.ru/map-constructor/location-tool/?from=club</small>
        <label for = "ads-price">Цена ₽:<input type = "number" name = "ads-price" id = "ads-price" autocomplete="off" min="0" placeholder="0" value = "0"; required></label>
        <label for = "ads-day">Длительность (дней):<input type = "number" name = "ads-day" id = "ads-day" autocomplete="off" min="1" placeholder="1" value = "1" required></label>
        <button name = "btn-addads">Добавить объявление</button>
    </form>
</main>
<?php
...
if(isset($_POST['btn-addads'])) {
    $addads = new Database();
    echo $addads->add_ads(htmlspecialchars($_POST['ads-header']), htmlspecialchars($_POST['ads-description']), htmlspecialchars($_POST['ads-region']), htmlspecialchars($_POST['ads-city']), htmlspecialchars($_POST['ads-coordinates']), htmlspecialchars($_POST['ads-price']), htmlspecialchars($_POST['ads-day']));
}
